...
function TeacherForm() {
  ...
  function setScheduleItemValeu(position: number, field: string, value: string) {
  ...
  return(
    <div id="page-teacher-form" className="container">
      <PageHeader title="Que inscrível que você quer dar aulas."
        ...
        <legend>
          ...
          {scheduleItems.map((scheduleItem, index) => {
            return(
              ...
              onChange={e => setScheduleItemValeu(index, 'week_day', e.target.value)}
              options={[
                { value: '0', label: 'Domingo'},
                { value: '1', label: 'Segunda-feira'},
                { value: '2', label: 'Terça-feira'},
                { value: '3', label: 'Quanta-feira'}, 
      ...
      <footer> 
        <p>
          <img src={warnigIcon} alt="Aviso muito importante"/>
          Importante <br />
